 ...
 * Slug: hill-street-realty/gallery-two-columns
 * Categories: hsr-gallery
 * Description: Two column image gallery grid
...
<div class="wp-block-group alignfull has-white-background-color has-background" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
    ...
    <div class="wp-block-columns">
        ...
        <div class="wp-block-column">
            ...
            <figure class="wp-block-image size-large" style="border-radius:0"><img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&q=80" alt="Gallery image 1"/></figure>
            <!-- /wp:image -->
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column">
            <!-- wp:image {"sizeSlug":"large","style":{"border":{"radius":"16px"}}} -->
            <figure class="wp-block-image size-large" style="border-radius:0"><img src="https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=600&q=80" alt="Gallery image 2"/></figure>
            <!-- /wp:image -->
        </div>
        <!-- /wp:column -->
    </div>
